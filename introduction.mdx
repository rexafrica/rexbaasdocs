...
- **Collections at a terminal or point of sale** — a distinct,
  inward-only account type purpose-built for this
  ([Merchant Accounts](/api-reference/merchant-accounts/create-a-merchant-account)) —
  see [Virtual vs. Merchant Accounts](/guides/virtual-vs-merchant-accounts)
  for which one fits your use case.
